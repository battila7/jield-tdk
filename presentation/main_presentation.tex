...
\begin{document}
  ...
  \input{./sections/02-generatorok-ismert-nyelvekben.tex}

  \input{./sections/03-korabbi-java-implementaciok.tex}

  \input{./sections/04-az-eljaras-egy-peldan-keresztul.tex}
  ...
  % \input{./sections/0x-continuation-passing-style.tex}
\end{document}
